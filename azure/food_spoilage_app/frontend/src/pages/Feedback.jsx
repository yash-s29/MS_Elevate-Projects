...
export default function Feedback() {
  ...
  const Header = () => (
    <header className="page-header">
      <div className="orb orb-sm orb-1" /><div className="orb orb-sm orb-2" />
        ...
        <Reveal>
          <section className="card empty-card">
            <div className="empty-state">
              ...
              <button className="btn btn-primary" onClick={() => { setDone(false); setForm({ name:'', email:'', message:'', rating:0 }); }}>
              ...
              <form className="feedback-form" onSubmit={submit} noValidate>
                  ...
                  <div className="form-group">
                    ...
                    <div className="input-wrap">
                      <input type="email" placeholder="your@email.com" autoComplete="email"
                        ...
                        className={errors.email ? 'error' : ''} style={{ paddingRight: 14 }} />
                    </div>
                ...
                <div className="form-group">
                  ...
                  <div className="textarea-wrap">
                    ...
                    />
                    <div className="char-count" style={{ color: form.message.length > 450 ? 'var(--danger)' : '' }}>
                ...
                <div className="form-footer-row">
                  <button type="submit" className="btn btn-primary btn-lg" disabled={loading}>
                    {loading ? <><SpinSVG /> Sending…</> : 'Send Feedback'}
                  </button>
